...
namespace MVCFrituurApplicatie_V3.Controllers
{
    public class AfrekenenController : Controller
    {
        private readonly ApplicationDbContext _context;

        public AfrekenenController(ApplicationDbContext context)
        {
            _context = context;
        }
        ...
        // GET: Afrekenen/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: Afrekenen/Create
